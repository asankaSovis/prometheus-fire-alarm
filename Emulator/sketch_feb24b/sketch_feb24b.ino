...
// NOTE: This code is for the emulator
...
#define DEVICE_INFO "{\"name\":\"Fire Alarm model\",\"version\":\"v1.2\",\"id\":\"WNsMSj5kJ0GhAs40pILnmTsjfkKvQO5C\"}" // Device info of the device
